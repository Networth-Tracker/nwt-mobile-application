  ...
  Future<BankSummaryResponse?> getBankSummary({
    ...
    try {
      ...
      if (response != null) {
        ...
        AppLogger.info('Get Bank Summary Response: ${responseData.toString()}', tag: 'BankService');
      ...
      AppLogger.error('Get Bank Summary Error', error: e, stackTrace: stackTrace, tag: 'BankService');
      return null;
    } finally {
      onLoading(false);
    }
