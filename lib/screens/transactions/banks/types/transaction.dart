class BankTransactionResponse {
    ...
    factory BankTransactionResponse.fromJson(Map<String, dynamic> json) => BankTransactionResponse(
        status: json["status"],
...
class TransactionData {
    ...
    factory TransactionData.fromJson(Map<String, dynamic> json) => TransactionData(
        banktransations: List<Banktransation>.from(json["banktransations"].map((x) => Banktransation.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "banktransations": List<dynamic>.from(banktransations.map((x) => x.toJson())),
    };
}
