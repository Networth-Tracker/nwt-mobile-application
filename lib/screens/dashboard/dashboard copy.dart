...
class DashboardOld extends StatefulWidget {
  ...
  @override
  State<DashboardOld> createState() => _DashboardState();
}

class _DashboardState extends State<DashboardOld>
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: LinearGradient(
                              colors: [Color(0xFF727272), AppColors.darkCardBG],
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    GetBuilder<DashboardAssetController>(
                                      builder: (controller) {
                                        if (controller.dashboardAssets?.data !=
                                            null) {
                                          return Row(
                                            children:
                                                controller
                            ...
                            ...List.generate(5, (index) {
                              return Container(
                                ...
                                padding: EdgeInsets.symmetric(
                                  ...
                                  vertical:
                                      16, // Slightly reduced vertical padding
                                ),
                                child: Row(
                                  children: [
                                    Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                            onTap: () => Get.to(() => MutualFundSwitchScreen()),
                                            child: AppText(
                                              "Switch Funds",
                                              variant: AppTextVariant.bodySmall,
                                              weight: AppTextWeight.semiBold,
