...
class PreciousMetalPage extends StatefulWidget {
  const PreciousMetalPage({super.key});
...
class _PreciousMetalPageState extends State<PreciousMetalPage> {
  ...
  final TextEditingController weightingmController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildField("Metal Type*", metaltypeController),
            _buildField("Metal Details (eg: Pendant Set, Rings)*", metaldetailsController),
            _buildDateField("Weight in gm*", weightingmController),
            _buildField("Purchased Value*", valueController),
            _buildDateField("Purchased Date*", dateController),
            _buildField("Purity", purityController),
            _buildField("Carat", caratController),
                      ...
                      children: [
                        Row(
                          ...
                          GestureDetector(
                            ...
                            child: const Icon(Icons.edit, color: Color(0xFF48AEE4), size: 20),
                          ),
                          ...
                          GestureDetector(
                            ...
                            child: const Icon(Icons.delete, color: Color(0xFFF2190D), size: 20),
                          ),
                        ],
                        ),
                        const AppText(
