...
class _LandPageState extends State<LandPage> {
  ...
  String selectedPropertyType = 'Agricultural';
  String selectedOwnershipType = 'Joint Holder';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildDropdown("Land Type", ['Agricultural', 'Commercial'], selectedPropertyType, (val) {
              setState(() {
                selectedPropertyType = val!;
              });
            }),
            _buildDropdown("Type of Ownership", ['Joint Holder', 'Joint'], selectedOwnershipType, (val) {
              setState(() {
                selectedOwnershipType = val!;
              });
            }),
            _buildField("Shareholding", areaController),
            _buildField("Area in sq ft", shareController),
            ...
            const SizedBox(height: 8),
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: const [
                    AppText("Supporting Document", variant: AppTextVariant.headline6,weight: AppTextWeight.semiBold ,colorType: AppTextColorType.primary,),
