                    ...
                    children: [
                      SizedBox(
                        ...
                        child: InsightsGraphWidget(
                          ...
                          threeMonthData:
                              _insightsService.getThreeMonthPerformanceData(),
                          sixMonthData:
                              _insightsService.getSixMonthPerformanceData(),
                          oneYearData:
                              _insightsService.getOneYearPerformanceData(),
                          fiveYearData:
                              _insightsService.getFiveYearPerformanceData(),
                          tenYearData:
                              _insightsService.getTenYearPerformanceData(),
                          // SIP return data
                          sipOneMonthData:
                              _insightsService.getSipOneMonthPerformanceData(),
                          sipThreeMonthData:
                              _insightsService
                                  .getSipThreeMonthPerformanceData(),
                          sipSixMonthData:
                              _insightsService.getSipSixMonthPerformanceData(),
                          sipOneYearData:
                              _insightsService.getSipOneYearPerformanceData(),
                          sipFiveYearData:
                              _insightsService.getSipFiveYearPerformanceData(),
                          sipTenYearData:
                              _insightsService.getSipTenYearPerformanceData(),
                        ),
                      ),
                      FundDetailsWidget(
                        expenseRatio:
                            '${_insightData!.funddetail.expenseratio}%',
                        churnValue: '${_insightData!.funddetail.churn}%',
                        investmentStyle:
                            _insightData!.funddetail.investmentstyle,
                      ...
                      SipDetailsWidget(
                        minimumSip: CurrencyFormatter.formatRupee(
                          double.parse(
                            _insightData!.sipdetail.minimumsip.toString(),
                          ),
                        ),
                        maximumSip: CurrencyFormatter.formatRupee(
                          double.parse(
                            _insightData!.sipdetail.maximumsip.toString(),
                          ),
                        ),
                      ...
                      FundsDistributionWidget(
                        equityDistribution: {
                          ...
                          'largecap':
                              _insightData!.funddistributionequity.largecap,
                          'smallcap':
                              _insightData!.funddistributionequity.smallcap,
                        },
                      ...
                      SectorAllocationWidget(
                        sectorItems: [
                          ...
                          SectorItem(
                            name: 'Industrial',
                            percentage:
                                _insightData!.sectorallocation.industrial,
                            progressColor: const Color(0xFF8B5CF6),
                          ),
                          SectorItem(
                            name: 'Real Estate',
                            percentage:
                                _insightData!.sectorallocation.realestate,
                          ...
                          SectorItem(
                            name: 'Utilities',
                            percentage:
                                _insightData!.sectorallocation.utilities,
                      ...
                      TopHoldingsWidget(
                        holdingItems:
                            _insightData!.top20Holding
                                .map(
                                  (holding) => HoldingItem(
                                    name: holding.name,
                                    logoUrl:
                                        'https://companieslogo.com/img/orig/KOTAKBANK.NS-36440c5e.png', // Default logo as API doesn't provide logos
